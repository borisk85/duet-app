...
# UI-категория "Другое" (Узбекистан/Кыргызстан/Таджикистан/Армения/Азербайджан/
# Грузия/Молдова + вне-СНГ) маппится на универсальный СНГ-список. Dict alias
# избегает захардкоживания "СНГ" в Dart-коде профиля/онбординга.
REGION_AVAILABILITY["Другое"] = REGION_AVAILABILITY["СНГ"]
# Узбекистан/Кыргызстан и остальные СНГ+ страны тоже ведут на СНГ fallback —
# добавлены явно чтобы Claude знал что это реальный регион, не ошибка.
for _region in ("Узбекистан", "Кыргызстан", "Таджикистан", "Армения",
                "Азербайджан", "Грузия", "Молдова"):
