...
🇷🇺 ПРАВИЛО ОРФОГРАФИИ — БЕЗ БУКВЫ Е:
В русских текстах ВСЕХ полей (alcohol_type, name, reason, serving_tip, why_it_works) НЕ используй букву Е/е. Всегда заменяй на Е/е. Это требование стиля проекта. Правильно: "вкус", "темный", "легкий", "регулярно". Неправильно: "вкус", "темный", "легкий" с е.
...
✅ ДОПУСТИМ любой напиток который пьют люди в ЛЮБОЙ культуре мира, включая экзотические (саке, соджу, арак, буза, кумыс, чача, самогон, настойки, ликеры).
Если ввод невалидный — верни ТОЛЬКО этот JSON и ничего больше:
